...
static void cros_ec_ring_init(void)
{
	...
	iio_device_attach_buffer(ring.cros_ec_ring_dev, ring.buff);
...
static int hid_als_probe(struct platform_device *pdev)
{
	...
	ret = hid_sensor_parse_common_attributes(hsdev, HID_USAGE_SENSOR_ALS,
					&als_state->common_attributes, als_sensitivity_addresses,
...
static int hid_accel_3d_probe(struct platform_device *pdev)
{
	...
	ret = hid_sensor_parse_common_attributes(hsdev, hsdev->usage,
					&accel_state->common_attributes, accel_3d_sensitivity_addresses,
