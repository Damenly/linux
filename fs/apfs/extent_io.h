...
#ifndef APFS_EXTENT_IO_H
#define APFS_EXTENT_IO_H
...
#define INLINE_EXTENT_BUFFER_PAGES     (APFS_MAX_METADATA_BLOCKSIZE / PAGE_SIZE)
...
typedef struct extent_map *(get_extent_t)(struct apfs_inode *inode,
...
#else
#define apfs_extent_buffer_leak_debug_check(fs_info)	do {} while (0)
#endif
